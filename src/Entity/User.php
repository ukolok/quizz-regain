...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Reponses::class, mappedBy="repondant")
     */
    private $reponses;

    /**
     * @ORM\OneToMany(targetEntity=Resultats::class, mappedBy="totaluser")
     */
    private $resultats;
    ...
    public function removeResultat(Resultats $resultat): self
    {
        if ($this->resultats->removeElement($resultat)) {
            // set the owning side to null (unless already changed)
            if ($resultat->getRepondant() === $this) {
                $resultat->setRepondant(null);
            }
        }
